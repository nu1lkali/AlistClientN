...
class AlistConstant {
  ...
  static const String landscapeVideoFitMode = 'landscapeVideoFitMode'; // 横屏全屏画面适配: 0=自适应, 1=铺满裁剪, 2=完整显示, 3=拉伸填满
  ...
  static const String subtitleMatchMode = 'subtitleMatchMode'; // 字幕匹配模式: 0=精确, 1=模糊, 2=双模式(默认)
